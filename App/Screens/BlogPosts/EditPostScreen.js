...
const EditPostScreen = props => {
    ...
    const {
        author, authorEmail, published, title, body,
        newImage, isLoaded, showDeleteModal, modalMessage, image,
    } = state;
    ...
    return (
        <View>
            <KeyboardAwareScrollView getTextInputRefs={()=>([bodyInput.current, titleInput.current])}>
